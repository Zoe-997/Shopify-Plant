...
$(document).ready(function() {
    ...
    function initialize() {
        if ($("#googleMap").length) {
            // Center
          var center = new google.maps.LatLng(38.904397, -76.981887);
          ...
          var image = '//cdn.shopify.com/s/files/1/1485/6894/t/21/assets/google-map-icon.png?16111654376830603110';
            var marker = new Marker({
                map: map,
                position: new google.maps.LatLng(38.904397, -76.981887),
                icon: image
            });
        }
    }
